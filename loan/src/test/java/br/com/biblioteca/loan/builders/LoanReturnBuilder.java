...
public class LoanReturnBuilder {
    ...
    public static UserAppDTO userApp(){
        return new UserAppDTO(1L,"teste nome",21,"46356357","001",null);
    }

    public static List<BookDTO> listBook(){
        BookDTO bookDTO = new BookDTO(1L,"teste title","teste resume","teste isbn","teste author", LocalDate.ofEpochDay(25-04-2020),"001",null);
